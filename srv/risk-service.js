...
module.exports = async(srv) => {
    ...
    messaging.on("sap/S4HANAOD/farz/ce/sap/s4/beh/businesspartner/v1/BusinessPartner/Changed/v1", async (msg) => {
    ...
    messaging.on("sap/S4HANAOD/farz/ce/sap/s4/beh/businesspartner/v1/BusinessPartner/Created/v1", async (msg) => {
        console.log("<< event caught", msg);
